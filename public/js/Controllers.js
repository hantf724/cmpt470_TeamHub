...
;(function () {
    ...
    module.controller('postController', [
            ...
            function ($scope, postList, $state, $http, $timeout, $rootScope, ErrorService, PostService, Upload, $q) {
                ...
                $scope.filter_post = 'All Posts';
                $scope.filter_creator_id = '';
                

                $scope.selectPostFilter = function (cid,uid) {
                    if (cid == '') {
                        $scope.filter_post = 'All Posts';
                    } else if (cid == uid) {
                        $scope.filter_post = 'My Posts';

                    }


                    $scope.filter_creator_id = cid;

                };

                $scope.filterPost = function (postCard) {
                    if (($scope.filter_creator_id == '')) {
                        $scope.current_number_of_selected_filter++;
                        return true;
                    }
                    if ($scope.user.user_id == postCard.creator_id) {
                        return true;
                    }
                    return false;
                };
